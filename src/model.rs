...
pub struct CleanupPlan {
    ...
    pub verification_protocol_version: u32,
...
pub struct CleanupPlanItem {
    ...
    pub all_remaining_candidates: Vec<CopyView>,
    pub verified_remaining_copies: Vec<CopyView>,
    pub failed_remaining_copies: Vec<CopyView>,
    pub unknown_identity_copies: Vec<CopyView>,
    pub generated_at: String,
    ...
    pub verified_remaining_path_copies: usize,
    pub verified_remaining_storage_objects: usize,
    pub verified_remaining_logical_volumes: usize,
    pub verified_remaining_physical_devices: usize,
    pub candidate_metadata_state: String,
    pub keeper_metadata_state: String,
    pub verification_failures: Vec<String>,
    pub physical_identity_warnings: Vec<String>,
